...
//    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (i == R.id.logout) {
            Intent intent = new Intent(ViewItems.this, Login.class);
...
//Message diet to phone
                        String cPermission= android.Manifest.permission.SEND_SMS;
                        String sPermission= android.Manifest.permission.INTERNET;
                        try{
                            if (ActivityCompat.checkSelfPermission(ViewItems.this,cPermission)!= PackageManager.PERMISSION_GRANTED){

                                ActivityCompat.requestPermissions(ViewItems.this,new String[]{cPermission},Request_Code_permission);
                        ...
                        try{
                            if (ActivityCompat.checkSelfPermission(getApplicationContext(),sPermission)!= PackageManager.PERMISSION_GRANTED){
                        ...
                        String phonenumber=result2;
                        System.out.println("My Phone number is:"+phonenumber);

                        SmsManager sms=SmsManager.getDefault();
                        String msg="Bean curd:" +v1+
                                "\nBroccoli:" +v2+
                                "\nCarrots:" +v3+
                                "\nCucumber:" +v4+
                                "\nBrinjal:" +v5+
            ...
            b1.setOnClickListener(new View.OnClickListener() {
                public void onClick(View v) {
                    ...
                    if ((caloriesesent - total) > 100) {
                        AlertDialog.Builder build = new AlertDialog.Builder(ViewItems.this);
                        build.setTitle("Add more items");
                        build.setMessage("Add more fruits to raise your calorie count");
